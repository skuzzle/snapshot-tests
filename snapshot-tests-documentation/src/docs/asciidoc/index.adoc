...
|https://search.maven.org/artifact/{groupId}/snapshot-tests-jackson/{revnumber}/jar[`snapshot-tests-jackson`]
...
----
testImplementation('{groupId}:snapshot-tests-jackson:{revnumber}') {
