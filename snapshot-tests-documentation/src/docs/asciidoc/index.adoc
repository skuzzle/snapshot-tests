...
This is a user manual for the _inofficial_ snapshot testing extension for JUnit5.
...
NOTE: If you use the `-jackson`, `-html` or `-jaxb` module there is no need to additionally declare a dependency to the 
`-core` module. It will be pulled in automatically.
