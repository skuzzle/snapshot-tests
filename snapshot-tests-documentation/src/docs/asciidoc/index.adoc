...
In case you don't care about line endings you should advise the framework to normalize line endings before writing
snapshot files. You can do that with the following annotation on either the test method or test class:
