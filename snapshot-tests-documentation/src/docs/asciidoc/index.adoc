...
* The module `snapshot-tests-jaxb` has been deprecated in favor of drop-in replacement `snapshot-tests-xml-legacy`. The
deprecated module will be removed with version `2.0.0`.
* The module `snapshot-tests-jaxb-jakarta` has been deprecated in favor of drop-in replacement `snapshot-tests-xml`. The
deprecated module will be removed with version `2.0.0`.
