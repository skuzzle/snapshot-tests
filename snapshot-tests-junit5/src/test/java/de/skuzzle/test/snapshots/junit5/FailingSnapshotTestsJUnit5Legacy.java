    ...
    void testFailBecauseSnapshotMismatch() throws Throwable {
        frameworkTest
                ...
                .hasMessage(String.format("Stored snapshot doesn't match actual result.%n"
                        ...
                        + "  7    - test%n"
                        + "     7 + NOT test",
                        Path.of("src/test/resources/de/skuzzle/test/snapshots/junit5/FailingSnapshotTestsJUnit5Legacy$FailBecauseSnapshotMismatch_snapshots/testWithSnapshot_0.snapshot")));
    }
    ...
    void testFailBecauseSnapshotMismatchWithRawLinenumbers() throws Throwable {
        frameworkTest
                ...
                .hasMessage(String.format("Stored snapshot doesn't match actual result.%n"
                        ...
                        + "  1    - test%n"
                        + "     1 + NOT test",
                        Path.of("src/test/resources/de/skuzzle/test/snapshots/junit5/FailingSnapshotTestsJUnit5Legacy$FailBecauseSnapshotMismatchWithRawLinenumbers_snapshots/testWithSnapshot_0.snapshot")));
    }
    ...
    void testFailBecauseSnapshotMismatchWithWhitespaces() throws Throwable {
        frameworkTest
                ...
                .hasMessage(String.format("Stored snapshot doesn't match actual result.%n"
                        ...
                        + "  8    - <<line3>>%n"
                        + "     8 + <<line5>>",
                        Path.of("src/test/resources/de/skuzzle/test/snapshots/junit5/FailingSnapshotTestsJUnit5Legacy$FailBecauseSnapshotMismatchWithWhitespaces_snapshots/testWithSnapshot_0.snapshot")));
    }
    ...
    void testSoftAssertions() throws Exception {
        MetaTest.junit5()
                ...
                .hasMessage(String.format("Stored snapshot doesn't match actual result.%n"
                        ...
                        + "  7    - <<test>>%n"
                        + "     7 + <<test2>>",
                        Path.of("src/test/resources/de/skuzzle/test/snapshots/junit5/FailingSnapshotTestsJUnit5Legacy$SoftAssertions_snapshots/testWithSnapshot_0.snapshot")))
                .hasSuppressedException(
                        new AssertionFailedError(String.format("Stored snapshot doesn't match actual result.%n"
                                ...
                                + "  7    - <<test>>%n"
                                + "     7 + <<test3>>",
                                Path.of("src/test/resources/de/skuzzle/test/snapshots/junit5/FailingSnapshotTestsJUnit5Legacy$SoftAssertions_snapshots/testWithSnapshot_1.snapshot"))));
    }
