...
Starting with release `1.8.0` you can find the NEW reference documentation for the latest release [here](https://${github.user}.github.io/${github.name}/docs/latest)
Or you can refer to the documentation of a specific release at [${project.version}](https://${github.user}.github.io/${github.name}/docs/${project.version})
