...
- [x] XML via [snapshot-tests-jaxb](https://search.maven.org/artifact/${project.groupId}/snapshot-tests-jaxb/${project.version}/jar) and [snapshot-tests-jakarta](https://search.maven.org/artifact/${project.groupId}/snapshot-tests-jakarta/${project.version}/jar)
