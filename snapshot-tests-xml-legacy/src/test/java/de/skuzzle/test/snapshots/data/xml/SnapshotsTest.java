...
public class SnapshotsTest {
    ...
    @Test
    void testXmlAlreadyAStringWithoutPrettyPrint(Snapshot snapshot) {
        final SnapshotTestResult snapshotResult = snapshot
    ...
    @Test
    void testAsXmlNoRootObject(Snapshot snapshot) {
    ...
    @Test
    void testAsXmlTextCompare(Snapshot snapshot) {
    ...
    @Test
    void testAsXmlStructureCompare(Snapshot snapshot) {
        final Person myself = determinePerson();
    ...
    @Test
    void testAsXmlStructureCompareBuilder(Snapshot snapshot) {
        final Person myself = determinePerson();
    ...
    @Test
    void testAsXmlStructureCompareCustomRule(Snapshot snapshot) {
    ...
    @Test
    void testAsXmlStructureCompareCustomRulesIgnoreOnly(Snapshot snapshot) {
        final Person myself = determinePerson();
