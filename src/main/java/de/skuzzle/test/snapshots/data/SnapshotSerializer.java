 ...
 * example, it would not make sense to serialize objects to json and then use XmlUnit to
 * perform the structural assertions.
 *
...
public interface SnapshotSerializer {
     ...
     * @throws SnapshotException If the object could not be serialized.
     * @since ever
     */
