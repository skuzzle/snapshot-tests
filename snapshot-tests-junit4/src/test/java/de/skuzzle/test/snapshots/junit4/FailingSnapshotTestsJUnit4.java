    ...
    public void testFailBecauseSnapshotMismatch() throws Throwable {
        frameworkTest
                ...
                .hasMessage(String.format("Stored snapshot doesn't match actual result.%n"
                        ...
                        + "  7    - test%n"
                        + "     7 + NOT test",
                        Path.of("src/test/resources/de/skuzzle/test/snapshots/junit4/FailingSnapshotTestsJUnit4$FailBecauseSnapshotMismatch_snapshots/testWithSnapshot_0.snapshot")));
    }
    ...
    public void testFailBecauseSnapshotMismatchWithRawLinenumbers() throws Throwable {
        frameworkTest
                ...
                .hasMessage(String.format("Stored snapshot doesn't match actual result.%n"
                        ...
                        + "  1    - test%n"
                        + "     1 + NOT test",
                        Path.of("src/test/resources/de/skuzzle/test/snapshots/junit4/FailingSnapshotTestsJUnit4$FailBecauseSnapshotMismatchWithRawLinenumbers_snapshots/testWithSnapshot_0.snapshot")));
    }
    ...
    public void testFailBecauseSnapshotMismatchWithWhitespaces() throws Throwable {
        frameworkTest
                ...
                .hasMessage(String.format("Stored snapshot doesn't match actual result.%n"
                        ...
                        + "  8    - <<line3>>%n"
                        + "     8 + <<line5>>",
                        Path.of("src/test/resources/de/skuzzle/test/snapshots/junit4/FailingSnapshotTestsJUnit4$FailBecauseSnapshotMismatchWithWhitespaces_snapshots/testWithSnapshot_0.snapshot")));
    }
